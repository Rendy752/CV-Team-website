...
export const resumes: ResumeData[] = [
	{
		...
		skills: [
			{
				category: 'Frontend',
				skills: ['ReactJS', 'NextJS', 'TypeScript', 'JavaScript', 'Bootstrap', 'Tailwind CSS']
			},
			{
				category: 'Backend',
				skills: ['PHP', 'Laravel', 'Codeigniter', 'Golang', 'NodeJS', 'NestJS']
			},
			{
				category: 'Database',
				skills: ['MySQL', 'PostgreSQL', 'Redis', 'Prisma ORM']
			},
			{
		...
		projects: [
			{
				...
				technologies: ['PHP (Laravel)', 'Golang', 'AWS RDS', 'Kubernetes', 'RabbitMQ']
			}
		]
	},

	{
		...
		skills: [
			...
			{
				category: 'Backend',
				skills: ['Python', 'Java', 'Node.js', 'Django', 'PHP (Basic)']
			},
			{
				category: 'Database',
				skills: ['MySQL', 'PostgreSQL (Basic)']
			},
			{
		...
		projects: [
			{
				...
				technologies: ['Python', 'MobileNetV2', 'YOLOv8', 'Computer Vision']
			}
		]
	},

	{
		...
		educations: [
			{
				...
				degree: 'Bachelor in Computer Science (IPK: 3.54/4.00)',
		...
		skills: [
			{
				category: 'Frontend',
				skills: ['HTML', 'JavaScript', 'Flutter']
			},
			{
				category: 'Backend',
			...
			{
				category: 'Tools & Technologies',
				skills: ['Google Cloud Platform', 'PostMan', 'C', 'C++']
			}
		],
		...
		projects: [
			{
				...
				duration: 'N/A',
				technologies: ['Python', 'Machine Learning', 'GUI']
			}
		]
	},

	{
		...
		skills: [
			{
				category: 'Frontend',
				skills: ['React.js', 'Vue.js', 'Nuxt.js', 'Tailwind CSS', 'TypeScript']
			},
			{
				category: 'Backend',
				skills: ['Golang', 'Laravel', 'Node.js', 'PHP', 'Java']
			},
			{
				category: 'Database',
			...
			{
				category: 'Tools & Technologies',
				skills: ['Git', 'GitHub', 'Figma', 'Docker', 'Postman', 'Keycloak']
			}
		],
		...
		projects: [
			{
				...
				duration: 'N/A',
				technologies: ['Vue', 'Tailwind', 'Laravel', 'MySQL']
			},
			{
				id: '3',
				...
				role: 'Full Stack Developer',
				duration: 'N/A',
				technologies: ['React', 'Laravel', 'MongoDB', 'Google API']
			}
		]
	},

	{
		...
		educations: [
			{
				...
				degree: 'Bachelor of Information Systems (GPA: 3.93/4.00)',
		...
		additionalActivities: [
			{
				...
				organization: 'Unit Kegiatan Mahasiswa Programming, Palembang',
		...
		skills: [
			...
			{
				category: 'Database',
				skills: ['MySQL', 'SQLite', 'Firebase', 'Room']
			},
			{
				category: 'Tools & Technologies',
				skills: ['Flutter', 'Jetpack Compose', 'Kotlin', 'Dart']
			}
		],
		...
		projects: [
...

			{
				...
				duration: 'N/A',
				technologies: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Socket.IO', 'LiveKit']
			},
...

			{
				...
				role: 'FullStack Developer',
				duration: 'N/A',
				technologies: ['JavaScript ES6', 'Web Components', 'Webpack', 'Materialize CSS']
			}
		]
	}
];
